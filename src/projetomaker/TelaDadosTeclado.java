...
public class TelaDadosTeclado extends javax.swing.JFrame {
    
    int operacao;
    String codigoBarra;
    
    public TelaDadosTeclado(int operacao, String codigoBarra) {
        initComponents();
        ...
        if (operacao == 1) {
            Titulo.setText("Cadastrar Teclado");
        }
        
        if (operacao == 2) {
            Titulo.setText("Editar Teclado");
            
            Teclado t1 = new Teclado();
            ProdutoDAO pd = new ProdutoDAO();
            
            t1 = pd.buscarTeclado(codigoBarra);
            
            txtCodigoBarra.setText(t1.getCodigoBarra());
            txtNome.setText(t1.getNome());
            txtMarca.setText(t1.getMarca());
            txtPreco.setText(String.valueOf(t1.getPreco()));
            txtModelo.setText(t1.getModelo());
            txtCor.setText(t1.getCor());
            boxRgb.equals(t1.isRgb());
            txtCodigoBarra.setEditable(false);
        }
        
        if (operacao == 3) {
            Titulo.setText("Remover Teclado");
    ...
    private void initComponents() {
        ...
        boxRgb = new javax.swing.JCheckBox();
        ...
        txtCor.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtCor.setText(" ");
        txtCor.setAutoscrolls(false);
        txtCor.setMargin(new java.awt.Insets(0, 0, 0, 0));
        txtCor.setMaximumSize(new java.awt.Dimension(56, 56));
        txtCor.setMinimumSize(new java.awt.Dimension(56, 56));
        ...
        txtModelo.setMargin(new java.awt.Insets(0, 0, 0, 0));
        txtModelo.setMaximumSize(new java.awt.Dimension(56, 56));
        txtModelo.setMinimumSize(new java.awt.Dimension(56, 56));
        ...
        boxRgb.setFont(new java.awt.Font("Agency FB", 1, 18)); // NOI18N
        boxRgb.setText("RGB?");
        ...
        Titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projetomaker/teclado1.png"))); // NOI18N
        Titulo.setText("Cadastrar Teclado");
    ...
    private void ConfirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmaActionPerformed
        ...
        t2.setCodigo(t1.getCodigo());
        
        t2.setCodigoBarra (                           txtCodigoBarra.getText().trim());
        
        if (operacao == 1 && pd.buscarTecladoCB(t2.getCodigoBarra()) == false) {
            t2.setTipo        (                       "Teclado");
            t2.setNome        (                       txtNome.getText().trim());
            t2.setMarca       (                       txtMarca.getText().trim());
            t2.setPreco       (Double.parseDouble (   txtPreco.getText().trim()));
            t2.getEstoque().setQuantidadeEstoque(0);
            t2.setModelo      (                   (   txtModelo.getText().trim()));
            t2.setCor         (                   (   txtCor.getText().trim()));
            t2.setRgb         (                       boxRgb.isSelected());
            
            if (pd.cadastrarTeclado(t2)) {
                String mensagem = "Teclado cadastrado!";
            ...
            if (pd.editarTeclado(t2)) {
                String mensagem = "Teclado alterado!";
                JOptionPane.showMessageDialog(null, mensagem);
                this.dispose();
            }
        } else if (operacao == 3) {
            ...
            if (pd.removerTeclado(t2)) {
                String mensagem = "Teclado excluído!";
                JOptionPane.showMessageDialog(null, mensagem);
                this.dispose();
            }
        } 
    ...
    public static void main(String args[]) {
            ...
            public void run() {
                new TelaDadosTeclado(0,"0").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JCheckBox boxRgb;
