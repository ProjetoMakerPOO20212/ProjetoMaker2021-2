...
public class TelaDadosMouse extends javax.swing.JFrame {
 ...
 // e o codigo do registro no banco, se codigo = 0 é uma inclusão 
  public TelaDadosMouse(int operacao, int codigo) {
    ...
    if (operacao == 2) {
      ...
      lb1.setText("Editar");
      // Cria um objeto mouses para receber os dados da consulta
      Mouses mol = new Mouses();
      // Cria um objeto ProdutoDAO para uso dos métodos de acesso
      // ao banco para os mouses
      ProdutoDAO pd = new ProdutoDAO();
      // Realiza a busca no Banco os dados do registro do mouses
      // através do codigo
      mol = pd.buscarMouse(codigo);
      // Preenche as caixas de texto com os dados do mouse
      txtNome.setText(mol.getNome());
      txtMarca.setText(mol.getMarca());
      txtPreco.setText(String.valueOf(mol.getPreco()));
      txtDpi.setText(String.valueOf(mol.getDpi()));
      txtPeso.setText(String.valueOf(mol.getPeso()));
    }
    if (operacao == 3) {
      ...
      // ao banco para os mouses
      ProdutoDAO pd = new ProdutoDAO();
      // Realiza a busca no Banco os dados do registro do mouse
      // através do codigo
      mol = pd.buscarMouse(codigo);
      // Preenche as caixas de texto com os dados do mouse
      txtNome.setText(mol.getNome());
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDpi, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        lb1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projetomaker/mouse.png"))); // NOI18N
        lb1.setText("INCLUIR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if (operacao == 1) { // Inclusão
        // Cria um objeto mouse para receber os dados da do preenchimento 
        // da tela
        Mouses mo1 = new Mouses();
        // Cria um objeto ProdutoDAO para uso dos métodos de acesso
        // ao banco para os mouses
        ProdutoDAO pd = new ProdutoDAO();
        // Determina os valores dos atributos do objeto mouse, com os dados
        // preenchidos na tela
        // o codigo é gerado automaticamente pelo Access
        mo1.setNome      (                       txtNome.getText().trim());
        mo1.setMarca     (                       txtMarca.getText().trim());
        mo1.setPreco     (Double.parseDouble (   txtPreco.getText().trim()));
        mo1.setDpi      (Integer.parseInt    (   txtDpi.getText().trim()));
        mo1.setPeso       (Double.parseDouble (  txtPeso.getText().trim()));
        mo1.getEstoque().setQtdEstoque(0);
        // Verifica se a operação de inserção obteve sucesso
        if (pd.inserirMouse(mo1)) {
          String mensagem = "Mouse Inserido!";
        ...
        mol.setCodigo    (                                         codigo);
        mol.setNome      (                       txtNome.getText().trim());
        mol.setMarca     (                       txtMarca.getText().trim());
        mol.setPreco     (Double.parseDouble (   txtPreco.getText().trim()));
        mol.setDpi       (Integer.parseInt   (   txtDpi.getText().trim()));
        mol.setPeso      (Double.parseDouble (   txtPeso.getText().trim()));
        // Verifica se a operação de alteração obteve sucesso
        if (pd.alterarMouse(mol)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDadosMouse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
